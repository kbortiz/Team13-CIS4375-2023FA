...
<template>
  <main>
    ...
    <div class="px-10 pt-20">
      ...
      >
        <h2 class="text-2xl font-bold">Search Promotion By</h2>
        ...
        <div class="flex flex-col">
          <select
            ...
            v-model="searchBy"
          >
            <option value="Event Name">Promotion Name</option>
            <option value="Event Date">End Date</option>
          </select>
        </div>
    ...
    >
      <div class="ml-10">
        <h2 class="text-2xl font-bold">List of Promotions</h2>
      ...
      <div class="flex flex-col col-span-2">
        <table class="min-w-full shadow-md rounded">
          <thead class="bg-gray-50 text-xl">
            <tr>
              <th class="p-4 text-left">Promotion Name</th>
              <th class="p-4 text-left">End Date</th>
              <th class="p-4 text-left">Points Required</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-300">
            ...
            >
              ...
              <td class="p-2 text-left">{{ event.pointcost }}</td>
            </tr>
          </tbody>
        </table>
      </div>
